...
//        name, relaseDate,description, genre, rating, numberOfEps
        ...
        Anime anime6 = new Anime("Kuroko's Basketball", LocalDate.of(2012, 04, 07), "High school basket ball team", Genre.ACTION, 4.5, 75);
...
//        TODO: ADD USERS
        ...
        User user5 = new User("Shiki", LocalDate.of(1999,9,14), "Shiki43@gmail.com", List.of(anime1,anime4,anime5));
        User user6 = new User("Randy", LocalDate.of(1599,5,15), "Randy432@gmail.com", List.of(anime1,anime4));
        User user7 = new User("Shuka", LocalDate.of(1999,9,2), "onodaKun@gmail.com", List.of(anime1));
        User user8 = new User("Obu", LocalDate.of(2003,9,3), "ObiObi@gmail.com", List.of(anime1,anime7,anime5));
        User user9 = new User("Kite", LocalDate.of(1998,6,6), "Kie7673@gmail.com", List.of(anime4,anime8,anime10));
        User user10 = new User("Pete", LocalDate.of(1987,9,23), "PITY@gmail.com", List.of(anime2,anime3,anime6,anime7));
        User user11 = new User("Kwnichi", LocalDate.of(1989,6,24), "koitd@gmail.com", List.of(anime1,anime2,anime3));
        User user12 = new User("Quinnie", LocalDate.of(2001,9,2), "qunie432@gmail.com", List.of(anime1));
